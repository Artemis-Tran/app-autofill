export const FIELD_ALIASES: Record<string, RegExp[]> = {
  ...
  "education.mostRecent.school": [/school|university|college|institution/i],
  "education.mostRecent.degree": [/degree|qualification/i],
  "education.mostRecent.field":  [/field|major|area of study|concentration/i],
  "education.mostRecent.start":  [/start\s*(date|year)|matriculation/i],
  "education.mostRecent.end":    [/(end|finish|graduation)\s*(date|year)|grad\s*(date|year)|expected graduation/i],
